...
<div class="animate-slide-up">
    ...
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="{{ route('animales.index') }}" class="px-6 py-3 bg-white/20 hover:bg-white/30 text-white rounded-xl transition-all backdrop-blur-sm border-2 border-white/30 shadow-lg">
